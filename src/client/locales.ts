...
const zh = {
  ...
  'card.running': '运行中',
  'card.hostDonePending': '宿主已完成，结果等待写入会话',
  'card.elapsed': '{n}s',
  'card.events': '{n} 条事件',
  'card.last': '最近 {type}',
  'card.sessionNew': '新建',
  ...
  'panel.sessionPending': 'session 待 harness 报告',
  'panel.segment': '过程 · {n} 步',
  'panel.dropped': '前 {n} 条事件已被丢弃，时间线从中途开始',
  'panel.replyAuthoritative': '完整回复（实录不完整，以下取权威文本）',
  'panel.errors': '错误',
  'panel.prompt': '发送的 prompt',
  'panel.promptExpand': '展开',
  'panel.promptCollapse': '收起',
  'panel.noOutput': '暂无输出',
  ...
  'panel.tokensIn': 'in',
  'panel.tokensOut': 'out',
  'panel.tokensCached': 'cached',
  'panel.tokensReason': 'reason',
  'panel.stderr': 'stderr',
  ...
  'settings.logs.warning': '原始日志可能包含完整 prompt、源码、命令输出、路径和其他敏感信息；文件会按配置自动轮转与截断。仅在需要诊断时开启。',
  'settings.access': '权限',
...
const en: Record<LocaleKey, string> = {
  ...
  'card.hostDonePending': 'Host finished; waiting to write the result into the session',
  'card.elapsed': '{n}s',
  ...
  'panel.sessionPending': 'session pending',
  'panel.segment': 'Process · {n} steps',
  'panel.dropped': 'The first {n} events were discarded; this timeline starts mid-run',
  'panel.replyAuthoritative': 'Full reply (transcript incomplete; authoritative text below)',
  'panel.errors': 'Errors',
  'panel.prompt': 'Prompt sent',
  'panel.promptExpand': 'Expand',
  'panel.promptCollapse': 'Collapse',
  ...
  'settings.logs.warning': 'Raw logs may contain complete prompts, source code, command output, paths, and other sensitive information; configured rotation and truncation bounds apply. Enable only for diagnostics.',
