...
import { ACCESS_MODES, EFFORT_LEVELS, isAccessMode, isEffortLevel, resolveRunPolicy, } from "../shared/policy.js";
 ...
 */
export function createHarnessCallTool(ctx, store, readSettings) {
    /**
    ...
    return defineTool({
        ...
        async execute(args, exec) {
            ...
            const accessOverride = isAccessMode(args.access)
                ? args.access
                : isAccessMode(args.codexSandbox)
                    ? args.codexSandbox
                    : undefined;
            const effortOverride = isEffortLevel(args.effort) ? args.effort : undefined;
