...
function toSummary(record) {
    ...
    if (record.callId !== undefined)
        summary.callId = record.callId;
    if (record.finishedAt !== undefined)
        summary.finishedAt = record.finishedAt;
    if (record.elapsedMs !== undefined)
        summary.elapsedMs = record.elapsedMs;
    if (record.ok !== undefined)
        summary.ok = record.ok;
    if (record.lastEventKind !== undefined)
        summary.lastEventKind = record.lastEventKind;
 ...
 */
function toStored(event, seq, at) {
    const stored = {};
